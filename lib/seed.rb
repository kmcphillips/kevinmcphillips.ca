module Seed
  def self.process!
    ...
    Project.create! :name => "AndrewLittlefor.com", :url => "http://andrewlittleford.com", :description => "This is a new Rails project that is just started up. I'm working with Andrew, a Winnipeg trumpet player, to gather requirements and start hammering out code."
